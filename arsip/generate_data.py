...
def generate_donor_data(num_donors):
    ...
    for i in range(num_donors):
        donor_id = f"D{i+1}"
        jenis_makanan = random.choice([['makanan'], ['minuman'], ['makanan', 'minuman']])
        ...
        kondisi_makanan = random.choice([['layak konsumsi'], ['hampir kadaluarsa'], ['tidak layak konsumsi']])
...
def generate_receiver_data(num_receivers):
    ...
    for i in range(num_receivers):
        receiver_id = f"T{i+1}"
        makanan_dibutuhkan = random.choice([['makanan'], ['minuman'], ['makanan', 'minuman']])
        ...
        kondisi_makanan_diterima = random.choice([
            ...
            ['layak konsumsi', 'hampir kadaluarsa']
        ])
